...
internal actual fun getString(string: Strings): String {
    ...
    return when (string) {
        ...
        Strings.Dialog -> resources.getString(io.github.qdsfdhvh.material3.R.string.dialog)
        Strings.MenuExpanded -> resources.getString(io.github.qdsfdhvh.material3.R.string.expanded)
        Strings.MenuCollapsed -> resources.getString(io.github.qdsfdhvh.material3.R.string.collapsed)
        else -> ""
    }
}